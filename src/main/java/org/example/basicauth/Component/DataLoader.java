...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (userRepository.count() == 0) {
            ...
            Customer customer = new Customer(null,3593L,"customer" ,passwordEncoder.encode("customer123"),"shyesilbas@gmail.com","Engineer",new BigDecimal("50000.00"),Role.CUSTOMER);
